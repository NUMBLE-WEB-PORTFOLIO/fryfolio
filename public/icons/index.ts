...
export { default as IconPomoLogo } from "./project/pomo.svg";
export { default as IconCollusicLogo } from "./project/collusic.svg";
export { default as IconOnthewayLogo } from "./project/ontheway.svg";
